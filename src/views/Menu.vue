  ...
  data() {
    return {
      ...
      list6: [
        {
          title: "紅茶",
          subtitle: "你知道的身為一家早餐店，有賣紅茶是一件再正常不過的事。",
          price: 15,
          withBread: false,
          drink: true,
        },
        ...
        {
          title: "檸檬紅茶",
          subtitle: "想要獨立特行？點檸檬紅茶，不會有人跟你搶的",
          price: 20,
          withBread: false,
          drink: true,
        },
        {
          title: "柳橙汁",
          subtitle: "愛喝假奶的人不會喜歡喝的，因為我們的奶茶不加入奶昔，只加純鮮奶",
          price: 20,
          withBread: false,
          drink: true,
        },
